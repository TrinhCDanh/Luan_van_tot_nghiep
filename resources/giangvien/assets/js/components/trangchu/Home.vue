            ...
            <div v-for="( ca, key ) in caList" :key="key">
              <div style="border: 1px solid white; height: 100px; background-color: #eeeeee">
                ...
                <div v-else  class="lichtruc-detail">
                  ...
                  <p>{{ checkLichtruc(ca.id, thu.id).tenphongmay }}</p>
...
export default {
  data:function(){
    return {
      ...
      giangvien_current_id: sessionStorage.getItem('giangvien_id') || '',
      hockyList: [],
      caList: [],
      thuList: [],
      phongmayList: [],
  ...
  methods: {
    fetchData() {
      ...
      Axios.get(_this.urlCurrent+'/api/hocky').then((response) => {
        ...
        Axios.get(_this.urlCurrent+'/api/lichday-giangvien/' + _this.selectedHocky + "/" + _this.giangvien_current_id).then((response) => {
        ...
        Axios.get(_this.urlCurrent+'/api/lich-nghi-ngay-nghi/giangvien/'  + _this.selectedHocky + "/" + _this.giangvien_current_id).then((response) => {
          _this.dangkynghiList = response.data;
        });

        Axios.get(_this.urlCurrent+'/api/lich-bu-ngay-bu/giangvien/'  + _this.selectedHocky + "/" + _this.giangvien_current_id).then((response) => {
