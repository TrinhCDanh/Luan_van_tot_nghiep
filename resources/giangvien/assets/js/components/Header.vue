<template>
    ...
    >
      <v-toolbar-title>
        <span class="hidden-sm-and-down">Trung tâm máy tính - Giảng viên</span>
      </v-toolbar-title>
      <v-spacer></v-spacer>
...
<script>
    ...
    export default {
        ...
        methods: {
          logout() {
            window.open(this.urlCurrent + '/giangvien/logout', '_self');
          },
        ...
        created: function() {
          var _this = this;
          let uri = location.origin+'/api/giangvien/'+ _this.giangvien_current_id + '/edit';
