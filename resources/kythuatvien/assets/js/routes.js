...
export const routes = [
	{ path: '/', component: Layout, name: 'Layout', children: [
		...
		{ path: '/kythuatvien/tinhtrangmay/:may_slug', component: TinhtrangList, name: 'TinhtrangList' },
		{ path: '/kythuatvien/tinhtrangmay/:may_slug/add', component: TinhtrangAdd, name: 'TinhtrangAdd' },
		{ path: '/kythuatvien/tinhtrangmay/:may_slug/edit/:id', component: TinhtrangEdit, name: 'TinhtrangEdit' },
		{ path: '/kythuatvien/tinhtrangmay/:may_slug/view/:id', component: TinhtrangView, name: 'TinhtrangView' },
		...
		{ path: '/kythuatvien/taikhoan/edit', component: TaikhoanEdit, name: 'TaikhoanEdit' },
	]}
