                ...
                <v-layout row wrap>
                    <v-flex xs12 sm6 md6>
                        ...
                        >
                            ...
                            ></v-text-field>
                            <v-date-picker v-model="monhoc.ngaybatdau"  @input="$refs.menubatdau.save(monhoc.ngaybatdau)"></v-date-picker>
                        </v-menu>
                    </v-flex>
                    <v-flex xs12 sm6 md6>
                        <v-menu
                        ...
                        >
                            ...
                            ></v-text-field>
                            <v-date-picker v-model="monhoc.ngayketthuc" @input="$refs.menuketthuc.save(monhoc.ngayketthuc)"></v-date-picker>
                        </v-menu>
                    </v-flex>
                </v-layout>
