        ...
        <v-card ref="form">
          ...
          <v-form v-model="valid" v-on:submit.prevent = "createphongmay" method="POST">
            <v-card-text>
              ...
              <v-text-field type="number" v-model="phongmay.soluongmay" :rules="soluongRules" label="Số lượng máy trong phòng" required></v-text-field>
 ...
 export default {
   ...
   methods: {
     createphongmay: function() {
       ...
       Axios.post(uri, _this.phongmay).then((response) => {
