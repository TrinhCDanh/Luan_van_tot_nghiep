...
<script>
 export default {
   ...
   created() {
      ...
      _this.may_slug = urlfullCurrent.slice(urlfullCurrent.lastIndexOf('tinhtrangmay/') + 13 , urlfullCurrent.indexOf('/add'));

      Axios.get(_this.urlCurrent+'/api/may/'+ _this.may_slug).then((response) => {
        //_this.tinhtrangmay = response.data;
