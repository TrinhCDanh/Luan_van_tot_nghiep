                                ...
                                <v-flex xs12 sm6 md6>
                                    ...
                                    >
                                        <v-text-field
                                                ...
                                                readonly required
                                        ></v-text-field>
                                        <v-date-picker v-model="hocky.ngaybatdau"
                                                       @input="$refs.menubatdau.save(hocky.ngaybatdau)"></v-date-picker>
                                    </v-menu>
                                </v-flex>
                                <v-spacer></v-spacer>
                                <v-flex xs12 sm6 md6>
                                    ...
                                    >
                                        ...
                                        ></v-text-field>
                                        <v-date-picker v-model="hocky.ngayketthuc"
                                                       @input="$refs.menuketthuc.save(hocky.ngayketthuc)"></v-date-picker>
                                    </v-menu>
                                </v-flex>
                            </v-layout>
